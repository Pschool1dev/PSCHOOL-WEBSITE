...
const MesFormations = () => {
  ...
  const handleDownload = (titre) => {
    toast.success(`Téléchargement du certificat : ${titre}`);
  };
            ...
            <div key={cert.id} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between hover:border-emerald-200 transition-all">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-emerald-600/60 font-bold uppercase mt-1 tracking-wider">Certifié par P.School</p>
                </div>
              </div>
              <button 
                onClick={() => handleDownload(cert.formation?.titre)}
